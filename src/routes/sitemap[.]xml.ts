    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/seguros/condominio", changefreq: "monthly", priority: "0.9" },
          { path: "/seguros/colegios", changefreq: "monthly", priority: "0.9" },
          { path: "/revision-poliza", changefreq: "monthly", priority: "0.8" },
